...
public class PythonSmartxClientCodegen extends AbstractPythonCodegen implements CodegenConfig {
    private final Logger LOGGER = LoggerFactory.getLogger(PythonSmartxClientCodegen.class);
    ...
    public PythonSmartxClientCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "python-smartx";
